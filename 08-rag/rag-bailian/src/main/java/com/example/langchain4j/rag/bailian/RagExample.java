package com.example.langchain4j.rag.bailian;
 ...
 * 阿里百炼平台 RAG 检索增强生成示例
 *
 * 演示如何使用阿里百炼平台实现 RAG (Retrieval-Augmented Generation)。
 * 使用 qwen-plus 作为 Chat 模型，text-embedding-v3 作为 Embedding 模型。
 */
public class RagExample {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("=== RAG 检索增强生成示例 (阿里百炼) ===\n");
