package com.example.langchain4j.embedding.bailian;
 ...
 * 阿里百炼平台文本向量化示例
 *
 * 演示如何使用 EmbeddingModel 进行文本向量化。
 * 阿里百炼平台支持 OpenAI 兼容协议，使用 text-embedding-v3 模型进行向量化。
 */
public class EmbeddingExample {
    ...
    public static void main(String[] args) {
        ...
        EmbeddingModel model = OpenAiEmbeddingModel.builder()
                ...
                .apiKey(apiKey)
                .modelName("text-embedding-v3")  // 阿里百炼 Embedding 模型
                .build();

        System.out.println("=== 文本向量化示例 (阿里百炼) ===\n");
