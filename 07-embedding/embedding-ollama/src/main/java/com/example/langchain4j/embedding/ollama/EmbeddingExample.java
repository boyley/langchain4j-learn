package com.example.langchain4j.embedding.ollama;
...
public class EmbeddingExample {
    ...
    public static void main(String[] args) {
        ...
        EmbeddingModel model = OllamaEmbeddingModel.builder()
                .baseUrl(baseUrl)
                .modelName("nomic-embed-text")  // 或其他 embedding 模型
                .build();

        System.out.println("=== 文本向量化示例 (Ollama) ===\n");
        System.out.println("Ollama 服务地址: " + baseUrl);
        System.out.println("使用模型: nomic-embed-text\n");
